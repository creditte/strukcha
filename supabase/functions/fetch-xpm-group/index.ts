 ...
 * exact-match table alone leaves real trusts Unclassified, which then strips
 * their relationships out of the diagram.
 */
...
function resolveEntityType(businessStructure?: string, clientName?: string): string {
