    ...
    el.innerHTML = `
      <div style="display:flex;min-height:100vh;align-items:center;justify-content:center;font-family:system-ui,sans-serif;padding:24px;">
        <div style="max-width:400px;text-align:center;">
          ...
          <button onclick="window.location.href='/login'" style="padding:8px 20px;border:1px solid #ccc;background:transparent;border-radius:6px;cursor:pointer;">Go to Login</button>
